$_mod.def("/marko$4.13.13/src/runtime/vdom/AsyncVDOMBuilder", function(require, exports, module, __filename, __dirname) { var EventEmitter = require('/events-light$1.0.5/src/index'/*"events-light"*/);
var vdom = require('/marko$4.13.13/src/runtime/vdom/vdom'/*"./vdom"*/);
...
var RenderResult = require('/marko$4.13.13/src/runtime/RenderResult'/*"../RenderResult"*/);
var defaultDocument = vdom.___defaultDocument;
var morphdom = require('/marko$4.13.13/src/morphdom/index'/*"../../morphdom"*/);
var attrsHelper = require('/marko$4.13.13/src/runtime/vdom/helper-attrs'/*"./helper-attrs"*/);
