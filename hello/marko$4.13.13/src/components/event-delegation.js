$_mod.def("/marko$4.13.13/src/components/event-delegation", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.13.13/src/components/util-browser'/*"./util"*/);
