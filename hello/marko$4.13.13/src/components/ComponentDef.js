$_mod.def("/marko$4.13.13/src/components/ComponentDef", function(require, exports, module, __filename, __dirname) { "use strict";
var repeatedRegExp = /\[\]$/;
var componentUtil = require('/marko$4.13.13/src/components/util-browser'/*"./util"*/);
var attachBubblingEvent = componentUtil.___attachBubblingEvent;
var addDelegatedEventHandler = require('/marko$4.13.13/src/components/event-delegation'/*"./event-delegation"*/)
    .___addDelegatedEventHandler;
var extend = require('/raptor-util$3.2.0/extend'/*"raptor-util/extend"*/);
var KeySequence = require('/marko$4.13.13/src/components/KeySequence'/*"./KeySequence"*/);
