$_mod.def("/marko$4.13.13/src/components/registry-browser", function(require, exports, module, __filename, __dirname) { var complain = "MARKO_DEBUG" && require('/complain$1.3.0/index'/*"complain"*/);
var defineComponent = require('/marko$4.13.13/src/components/defineComponent'/*"./defineComponent"*/);
var loader = require('/marko$4.13.13/src/loader/index-browser-dynamic'/*"../loader"*/);
