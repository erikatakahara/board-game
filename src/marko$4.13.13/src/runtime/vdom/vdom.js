$_mod.def("/marko$4.13.13/src/runtime/vdom/vdom", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.13.13/src/runtime/vdom/VNode'/*"./VNode"*/);
var VComment = require('/marko$4.13.13/src/runtime/vdom/VComment'/*"./VComment"*/);
var VDocumentFragment = require('/marko$4.13.13/src/runtime/vdom/VDocumentFragment'/*"./VDocumentFragment"*/);
var VElement = require('/marko$4.13.13/src/runtime/vdom/VElement'/*"./VElement"*/);
var VText = require('/marko$4.13.13/src/runtime/vdom/VText'/*"./VText"*/);
var VComponent = require('/marko$4.13.13/src/runtime/vdom/VComponent'/*"./VComponent"*/);
var VFragment = require('/marko$4.13.13/src/runtime/vdom/VFragment'/*"./VFragment"*/);
