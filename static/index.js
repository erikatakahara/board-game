...
$_mod.main("/board-game$1.0.0/components/home", "index.marko");
$_mod.installed("board-game$1.0.0", "marko", "4.13.11");
$_mod.main("/marko$4.13.11/src/runtime/vdom", "");
$_mod.main("/marko$4.13.11/src", "");
$_mod.remap("/marko$4.13.11/src/index", "/marko$4.13.11/src/index-browser");
$_mod.def("/marko$4.13.11/src/runtime/createOut", function(require, exports, module, __filename, __dirname) { var actualCreateOut;
...
$_mod.main("/marko$4.13.11/src/loader", "");
$_mod.remap("/marko$4.13.11/src/loader/index", "/marko$4.13.11/src/loader/index-browser");
$_mod.remap("/marko$4.13.11/src/loader/index-browser", "/marko$4.13.11/src/loader/index-browser-dynamic");
$_mod.def("/marko$4.13.11/src/loader/index-browser-dynamic", function(require, exports, module, __filename, __dirname) { "use strict";
...
$_mod.def("/marko$4.13.11/src/index-browser", function(require, exports, module, __filename, __dirname) { "use strict";
exports.createOut = require('/marko$4.13.11/src/runtime/createOut'/*"./runtime/createOut"*/);
exports.load = require('/marko$4.13.11/src/loader/index-browser-dynamic'/*"./loader"*/);
...
$_mod.def("/marko$4.13.11/src/runtime/vdom/VNode", function(require, exports, module, __filename, __dirname) { /* jshint newcap:false */
function VNode() {}
...
$_mod.def("/marko$4.13.11/src/runtime/vdom/VComment", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.13.11/src/runtime/vdom/VNode'/*"./VNode"*/);
...
$_mod.def("/marko$4.13.11/src/runtime/vdom/VDocumentFragment", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.13.11/src/runtime/vdom/VNode'/*"./VNode"*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*"raptor-util/inherit"*/);
...
$_mod.def("/marko$4.13.11/src/components/dom-data", function(require, exports, module, __filename, __dirname) { var counter = 0;
var seed = require.resolve('/marko$4.13.11/src/components/dom-data'/*"./dom-data"*/);
var WeakMap =
    global.WeakMap ||
    function WeakMap() {
        var id = seed + counter++;
...
$_mod.def("/marko$4.13.11/src/runtime/vdom/VElement", function(require, exports, module, __filename, __dirname) { /* jshint newcap:false */
var domData = require('/marko$4.13.11/src/components/dom-data'/*"../../components/dom-data"*/);
var vElementByDOMNode = domData.___vElementByDOMNode;
var VNode = require('/marko$4.13.11/src/runtime/vdom/VNode'/*"./VNode"*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*"raptor-util/inherit"*/);
...
$_mod.def("/marko$4.13.11/src/runtime/vdom/VText", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.13.11/src/runtime/vdom/VNode'/*"./VNode"*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*"raptor-util/inherit"*/);
...
$_mod.def("/marko$4.13.11/src/runtime/vdom/VComponent", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.13.11/src/runtime/vdom/VNode'/*"./VNode"*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*"raptor-util/inherit"*/);
...
$_mod.def("/marko$4.13.11/src/morphdom/helpers", function(require, exports, module, __filename, __dirname) { function insertBefore(node, referenceNode, parentNode) {
    if (node.insertInto) {
...
$_mod.def("/marko$4.13.11/src/morphdom/fragment", function(require, exports, module, __filename, __dirname) { var helpers = require('/marko$4.13.11/src/morphdom/helpers'/*"./helpers"*/);
...
$_mod.def("/marko$4.13.11/src/runtime/vdom/VFragment", function(require, exports, module, __filename, __dirname) { var domData = require('/marko$4.13.11/src/components/dom-data'/*"../../components/dom-data"*/);
var keysByDOMNode = domData.___keyByDOMNode;
var vElementByDOMNode = domData.___vElementByDOMNode;
var VNode = require('/marko$4.13.11/src/runtime/vdom/VNode'/*"./VNode"*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*"raptor-util/inherit"*/);
var createFragmentNode = require('/marko$4.13.11/src/morphdom/fragment'/*"../../morphdom/fragment"*/)
...
$_mod.def("/marko$4.13.11/src/runtime/vdom/vdom", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.13.11/src/runtime/vdom/VNode'/*"./VNode"*/);
var VComment = require('/marko$4.13.11/src/runtime/vdom/VComment'/*"./VComment"*/);
var VDocumentFragment = require('/marko$4.13.11/src/runtime/vdom/VDocumentFragment'/*"./VDocumentFragment"*/);
var VElement = require('/marko$4.13.11/src/runtime/vdom/VElement'/*"./VElement"*/);
var VText = require('/marko$4.13.11/src/runtime/vdom/VText'/*"./VText"*/);
var VComponent = require('/marko$4.13.11/src/runtime/vdom/VComponent'/*"./VComponent"*/);
var VFragment = require('/marko$4.13.11/src/runtime/vdom/VFragment'/*"./VFragment"*/);
...
$_mod.remap("/marko$4.13.11/src/components/util", "/marko$4.13.11/src/components/util-browser");
$_mod.def("/marko$4.13.11/src/components/util-browser", function(require, exports, module, __filename, __dirname) { var domData = require('/marko$4.13.11/src/components/dom-data'/*"./dom-data"*/);
...
$_mod.def("/marko$4.13.11/src/runtime/dom-insert", function(require, exports, module, __filename, __dirname) { var extend = require('/raptor-util$3.2.0/extend'/*"raptor-util/extend"*/);
var componentsUtil = require('/marko$4.13.11/src/components/util-browser'/*"../components/util"*/);
var destroyComponentForNode = componentsUtil.___destroyComponentForNode;
var destroyNodeRecursive = componentsUtil.___destroyNodeRecursive;
var helpers = require('/marko$4.13.11/src/morphdom/helpers'/*"../morphdom/helpers"*/);
...
$_mod.def("/marko$4.13.11/src/runtime/RenderResult", function(require, exports, module, __filename, __dirname) { var domInsert = require('/marko$4.13.11/src/runtime/dom-insert'/*"./dom-insert"*/);
...
$_mod.main("/marko$4.13.11/src/morphdom", "");
$_mod.def("/marko$4.13.11/src/morphdom/specialElHandlers", function(require, exports, module, __filename, __dirname) { function syncBooleanAttrProp(fromEl, toEl, name) {
...
$_mod.def("/marko$4.13.11/src/components/event-delegation", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.13.11/src/components/util-browser'/*"./util"*/);
...
$_mod.def("/marko$4.13.11/src/morphdom/index", function(require, exports, module, __filename, __dirname) { "use strict";
var specialElHandlers = require('/marko$4.13.11/src/morphdom/specialElHandlers'/*"./specialElHandlers"*/);
var componentsUtil = require('/marko$4.13.11/src/components/util-browser'/*"../components/util"*/);
...
var VElement = require('/marko$4.13.11/src/runtime/vdom/vdom'/*"../runtime/vdom/vdom"*/).___VElement;
var virtualizeElement = VElement.___virtualize;
var morphAttrs = VElement.___morphAttrs;
var eventDelegation = require('/marko$4.13.11/src/components/event-delegation'/*"../components/event-delegation"*/);
var fragment = require('/marko$4.13.11/src/morphdom/fragment'/*"./fragment"*/);
var helpers = require('/marko$4.13.11/src/morphdom/helpers'/*"./helpers"*/);
var domData = require('/marko$4.13.11/src/components/dom-data'/*"../components/dom-data"*/);
var keysByDOMNode = domData.___keyByDOMNode;
...
$_mod.def("/marko$4.13.11/src/runtime/vdom/helper-styleAttr", function(require, exports, module, __filename, __dirname) { var dashedNames = {};
...
$_mod.def("/marko$4.13.11/src/compiler/util/removeDashes", function(require, exports, module, __filename, __dirname) { module.exports = function removeDashes(str) {
...
$_mod.def("/marko$4.13.11/src/components/KeySequence", function(require, exports, module, __filename, __dirname) { function KeySequence() {
    this.___lookup = {};
}
...
$_mod.def("/marko$4.13.11/src/components/GlobalComponentsContext", function(require, exports, module, __filename, __dirname) { var nextComponentIdProvider = require('/marko$4.13.11/src/components/util-browser'/*"./util"*/).___nextComponentIdProvider;
var KeySequence = require('/marko$4.13.11/src/components/KeySequence'/*"./KeySequence"*/);
...
$_mod.def("/marko$4.13.11/src/components/ComponentsContext", function(require, exports, module, __filename, __dirname) { "use strict";
var GlobalComponentsContext = require('/marko$4.13.11/src/components/GlobalComponentsContext'/*"./GlobalComponentsContext"*/);
...
$_mod.def("/marko$4.13.11/src/components/ComponentDef", function(require, exports, module, __filename, __dirname) { "use strict";
var repeatedRegExp = /\[\]$/;
var componentUtil = require('/marko$4.13.11/src/components/util-browser'/*"./util"*/);
var attachBubblingEvent = componentUtil.___attachBubblingEvent;
var addDelegatedEventHandler = require('/marko$4.13.11/src/components/event-delegation'/*"./event-delegation"*/)
...
$_mod.def("/marko$4.13.11/src/runtime/helpers", function(require, exports, module, __filename, __dirname) { "use strict";
var removeDashes = require('/marko$4.13.11/src/compiler/util/removeDashes'/*"../compiler/util/removeDashes"*/);
var ComponentsContext = require('/marko$4.13.11/src/components/ComponentsContext'/*"../components/ComponentsContext"*/);
var getComponentsContext = ComponentsContext.___getComponentsContext;
var ComponentDef = require('/marko$4.13.11/src/components/ComponentDef'/*"../components/ComponentDef"*/);
...
$_mod.def("/marko$4.13.11/src/runtime/vdom/helpers", function(require, exports, module, __filename, __dirname) { "use strict";

var vdom = require('/marko$4.13.11/src/runtime/vdom/vdom'/*"./vdom"*/);
var VElement = vdom.___VElement;
var VText = vdom.___VText;

var commonHelpers = require('/marko$4.13.11/src/runtime/helpers'/*"../helpers"*/);
var extend = require('/raptor-util$3.2.0/extend'/*"raptor-util/extend"*/);
...
var helpers = extend(
    {
        ...
        as: require('/marko$4.13.11/src/runtime/vdom/helper-attrs'/*"./helper-attrs"*/)
    },
    commonHelpers
);
...
$_mod.def("/marko$4.13.11/src/runtime/vdom/helper-attrs", function(require, exports, module, __filename, __dirname) { /**
...
var styleAttr = require('/marko$4.13.11/src/runtime/vdom/helper-styleAttr'/*"./helper-styleAttr"*/);
var classAttr = require('/marko$4.13.11/src/runtime/vdom/helpers'/*"./helpers"*/).ca;

});
$_mod.def("/marko$4.13.11/src/runtime/vdom/AsyncVDOMBuilder", function(require, exports, module, __filename, __dirname) { var EventEmitter = require('/events-light$1.0.5/src/index'/*"events-light"*/);
var vdom = require('/marko$4.13.11/src/runtime/vdom/vdom'/*"./vdom"*/);
var VElement = vdom.___VElement;
...
var RenderResult = require('/marko$4.13.11/src/runtime/RenderResult'/*"../RenderResult"*/);
var defaultDocument = vdom.___defaultDocument;
var morphdom = require('/marko$4.13.11/src/morphdom/index'/*"../../morphdom"*/);
var attrsHelper = require('/marko$4.13.11/src/runtime/vdom/helper-attrs'/*"./helper-attrs"*/);
...
$_mod.def("/marko$4.13.11/src/runtime/renderable", function(require, exports, module, __filename, __dirname) { var defaultCreateOut = require('/marko$4.13.11/src/runtime/createOut'/*"./createOut"*/);
var extend = require('/raptor-util$3.2.0/extend'/*"raptor-util/extend"*/);
...
$_mod.def("/marko$4.13.11/src/runtime/vdom/index", function(require, exports, module, __filename, __dirname) { "use strict";
require('/marko$4.13.11/src/index-browser'/*"../../"*/);

// helpers provide a core set of various utility methods
// that are available in every template
var AsyncVDOMBuilder = require('/marko$4.13.11/src/runtime/vdom/AsyncVDOMBuilder'/*"./AsyncVDOMBuilder"*/);
var makeRenderable = require('/marko$4.13.11/src/runtime/renderable'/*"../renderable"*/);
...
require('/marko$4.13.11/src/runtime/createOut'/*"../createOut"*/).___setCreateOut(createOut);

});
$_mod.def("/marko$4.13.11/src/vdom", function(require, exports, module, __filename, __dirname) { module.exports = require('/marko$4.13.11/src/runtime/vdom/index'/*"./runtime/vdom"*/);

});
$_mod.remap("/marko$4.13.11/src/components/helpers", "/marko$4.13.11/src/components/helpers-browser");
$_mod.main("/marko$4.13.11/src/components", "");
$_mod.remap("/marko$4.13.11/src/components/index", "/marko$4.13.11/src/components/index-browser");
$_mod.remap("/marko$4.13.11/src/components/init-components", "/marko$4.13.11/src/components/init-components-browser");
...
$_mod.remap("/marko$4.13.11/src/components/registry", "/marko$4.13.11/src/components/registry-browser");
$_mod.installed("marko$4.13.11", "complain", "1.3.0");
$_mod.main("/complain$1.3.0", "");
$_mod.installed("complain$1.3.0", "process", "0.11.10");
...
$_mod.def("/marko$4.13.11/src/components/State", function(require, exports, module, __filename, __dirname) { var extend = require('/raptor-util$3.2.0/extend'/*"raptor-util/extend"*/);
...
$_mod.remap("/marko$4.13.11/src/runtime/nextTick", "/marko$4.13.11/src/runtime/nextTick-browser");
$_mod.def("/marko$4.13.11/src/runtime/nextTick-browser", function(require, exports, module, __filename, __dirname) { /* globals window */
...
$_mod.def("/marko$4.13.11/src/components/update-manager", function(require, exports, module, __filename, __dirname) { "use strict";

var updatesScheduled = false;
var batchStack = []; // A stack of batched updates
var unbatchedQueue = []; // Used for scheduled batched updates

var nextTick = require('/marko$4.13.11/src/runtime/nextTick-browser'/*"../runtime/nextTick"*/);
...
$_mod.def("/marko$4.13.11/src/components/Component", function(require, exports, module, __filename, __dirname) { "use strict";
/* jshint newcap:false */

var complain = "MARKO_DEBUG" && require('/complain$1.3.0/index'/*"complain"*/);

var domInsert = require('/marko$4.13.11/src/runtime/dom-insert'/*"../runtime/dom-insert"*/);
var defaultCreateOut = require('/marko$4.13.11/src/runtime/createOut'/*"../runtime/createOut"*/);
var getComponentsContext = require('/marko$4.13.11/src/components/ComponentsContext'/*"./ComponentsContext"*/)
    .___getComponentsContext;
var componentsUtil = require('/marko$4.13.11/src/components/util-browser'/*"./util"*/);
var componentLookup = componentsUtil.___componentLookup;
...
var RenderResult = require('/marko$4.13.11/src/runtime/RenderResult'/*"../runtime/RenderResult"*/);
var SubscriptionTracker = require('/listener-tracker$2.0.0/lib/listener-tracker'/*"listener-tracker"*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*"raptor-util/inherit"*/);
var updateManager = require('/marko$4.13.11/src/components/update-manager'/*"./update-manager"*/);
var morphdom = require('/marko$4.13.11/src/morphdom/index'/*"../morphdom"*/);
var eventDelegation = require('/marko$4.13.11/src/components/event-delegation'/*"./event-delegation"*/);
var domData = require('/marko$4.13.11/src/components/dom-data'/*"./dom-data"*/);
var componentsByDOMNode = domData.___componentByDOMNode;
...
$_mod.def("/marko$4.13.11/src/components/defineComponent", function(require, exports, module, __filename, __dirname) { "use strict";
/* jshint newcap:false */

var BaseState = require('/marko$4.13.11/src/components/State'/*"./State"*/);
var BaseComponent = require('/marko$4.13.11/src/components/Component'/*"./Component"*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*"raptor-util/inherit"*/);
...
$_mod.def("/marko$4.13.11/src/components/registry-browser", function(require, exports, module, __filename, __dirname) { var complain = "MARKO_DEBUG" && require('/complain$1.3.0/index'/*"complain"*/);
var defineComponent = require('/marko$4.13.11/src/components/defineComponent'/*"./defineComponent"*/);
var loader = require('/marko$4.13.11/src/loader/index-browser-dynamic'/*"../loader"*/);
...
$_mod.def("/marko$4.13.11/src/components/init-components-browser", function(require, exports, module, __filename, __dirname) { "use strict";
var warp10Finalize = require('/warp10$1.3.6/finalize'/*"warp10/finalize"*/);
var eventDelegation = require('/marko$4.13.11/src/components/event-delegation'/*"./event-delegation"*/);
var win = window;
var defaultDocument = document;
var createFragmentNode = require('/marko$4.13.11/src/morphdom/fragment'/*"../morphdom/fragment"*/).___createFragmentNode;
var componentsUtil = require('/marko$4.13.11/src/components/util-browser'/*"./util"*/);
var componentLookup = componentsUtil.___componentLookup;
var addComponentRootToKeyedElements =
    componentsUtil.___addComponentRootToKeyedElements;
var ComponentDef = require('/marko$4.13.11/src/components/ComponentDef'/*"./ComponentDef"*/);
var registry = require('/marko$4.13.11/src/components/registry-browser'/*"./registry"*/);
var domData = require('/marko$4.13.11/src/components/dom-data'/*"./dom-data"*/);
var componentsByDOMNode = domData.___componentByDOMNode;
...
$_mod.def("/marko$4.13.11/src/components/index-browser", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.13.11/src/components/util-browser'/*"./util"*/);
var initComponents = require('/marko$4.13.11/src/components/init-components-browser'/*"./init-components"*/);
var registry = require('/marko$4.13.11/src/components/registry-browser'/*"./registry"*/);

require('/marko$4.13.11/src/components/ComponentsContext'/*"./ComponentsContext"*/).___initClientRendered =
...
$_mod.remap("/marko$4.13.11/src/components/beginComponent", "/marko$4.13.11/src/components/beginComponent-browser");
$_mod.def("/marko$4.13.11/src/components/beginComponent-browser", function(require, exports, module, __filename, __dirname) { var ComponentDef = require('/marko$4.13.11/src/components/ComponentDef'/*"./ComponentDef"*/);
...
$_mod.remap("/marko$4.13.11/src/components/endComponent", "/marko$4.13.11/src/components/endComponent-browser");
$_mod.def("/marko$4.13.11/src/components/endComponent-browser", function(require, exports, module, __filename, __dirname) { "use strict";
...
$_mod.def("/marko$4.13.11/src/components/renderer", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.13.11/src/components/util-browser'/*"./util"*/);
var componentLookup = componentsUtil.___componentLookup;
var emitLifecycleEvent = componentsUtil.___emitLifecycleEvent;

var ComponentsContext = require('/marko$4.13.11/src/components/ComponentsContext'/*"./ComponentsContext"*/);
var getComponentsContext = ComponentsContext.___getComponentsContext;
var registry = require('/marko$4.13.11/src/components/registry-browser'/*"./registry"*/);
var copyProps = require('/raptor-util$3.2.0/copyProps'/*"raptor-util/copyProps"*/);
var isServer = componentsUtil.___isServer === true;
var beginComponent = require('/marko$4.13.11/src/components/beginComponent-browser'/*"./beginComponent"*/);
var endComponent = require('/marko$4.13.11/src/components/endComponent-browser'/*"./endComponent"*/);
...
$_mod.def("/marko$4.13.11/src/components/helpers-browser", function(require, exports, module, __filename, __dirname) { require('/marko$4.13.11/src/components/index-browser'/*"./"*/);

exports.c = require('/marko$4.13.11/src/components/defineComponent'/*"./defineComponent"*/); // Referenced by compiled templates
exports.r = require('/marko$4.13.11/src/components/renderer'/*"./renderer"*/); // Referenced by compiled templates
exports.rc = require('/marko$4.13.11/src/components/registry-browser'/*"./registry"*/).___register; // Referenced by compiled templates

});
$_mod.def("/board-game$1.0.0/components/board-list/index.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.13.11 - DO NOT EDIT
"use strict";

var marko_template = module.exports = require('/marko$4.13.11/src/vdom'/*"marko/src/vdom"*/).t(),
    marko_component = {
        onCreate: function() {
          console.log("yay");
        }
      },
    components_helpers = require('/marko$4.13.11/src/components/helpers-browser'/*"marko/src/components/helpers"*/),
    marko_registerComponent = components_helpers.rc,
    marko_componentType = marko_registerComponent("/board-game$1.0.0/components/board-list/index.marko", function() {
      return module.exports;
    }),
    marko_renderer = components_helpers.r,
    marko_defineComponent = components_helpers.c,
    marko_helpers = require('/marko$4.13.11/src/runtime/vdom/helpers'/*"marko/src/runtime/vdom/helpers"*/),
    marko_createElement = marko_helpers.e,
    marko_const = marko_helpers.const,
    marko_const_nextId = marko_const("c9e16b"),
...
$_mod.def("/board-game$1.0.0/components/home/index.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.13.11 - DO NOT EDIT
"use strict";
...
var marko_template = module.exports = require('/marko$4.13.11/src/vdom'/*"marko/src/vdom"*/).t(),
    marko_component = {
        ...
        list: function() {
          this.state.current_page = "board-game-list";
        }
      },
    components_helpers = require('/marko$4.13.11/src/components/helpers-browser'/*"marko/src/components/helpers"*/),
    marko_registerComponent = components_helpers.rc,
    marko_componentType = marko_registerComponent("/board-game$1.0.0/components/home/index.marko", function() {
      return module.exports;
    }),
    marko_renderer = components_helpers.r,
    marko_defineComponent = components_helpers.c,
    board_list_template = require('/board-game$1.0.0/components/board-list/index.marko'/*"../board-list/index.marko"*/),
    marko_helpers = require('/marko$4.13.11/src/runtime/vdom/helpers'/*"marko/src/runtime/vdom/helpers"*/),
    marko_loadTag = marko_helpers.t,
    board_list_tag = marko_loadTag(board_list_template),
    marko_attrs0 = {
        "class": "content"
      },
    marko_attrs1 = {
    ...
    marko_createElement = marko_helpers.e,
    marko_const = marko_helpers.const,
    marko_const_nextId = marko_const("6f1480"),
    marko_node0 = marko_createElement("SECTION", null, "6", null, 1, 0, {
        i: marko_const_nextId()
      })
      .t("Home!");
...
function render(input, out, __component, component, state) {
  ...
  out.e("HEADER", null, "0", component, 2)
    .t("My board game webapp ")
    .e("NAV", marko_attrs1, "1", component, 2)
      .e("A", marko_attrs2, "2", component, 1, 0, {
          onclick: __component.d("click", "home", false)
        })
        .t("home")
      .e("A", marko_attrs3, "3", component, 1, 0, {
          onclick: __component.d("click", "list", false)
        })
        .t("My board games");

  out.be("DIV", marko_attrs0, "4", component);

  if (state.current_page == "board-game-list") {
    board_list_tag({}, out, __component, "5");
  } else {
    out.n(marko_node0, component);
  }
...
$_mod.def("/board-game$1.0.0/client", function(require, exports, module, __filename, __dirname) { var indexTemplate = require('/board-game$1.0.0/components/home/index.marko'/*'./components/home'*/);

indexTemplate.renderSync({ title: 'My test wow' })
    .appendTo(document.body);
});
$_mod.run("/board-game$1.0.0/client");